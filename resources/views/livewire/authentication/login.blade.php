<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form wire:submit.prevent="authenticateUser" class="space-y-6" action="#" method="POST">
      <div>
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a wire:click.prevent="$emit('updateView', 'forgot-password')"  href="#" class="font-semibold text-blue-700 hover:text-blue-500">Forgot password?</a>
          </div>
        </div>
        <div class="mt-2">
          <input wire:model.defer="password" id="password" name="password" type="password" autocomplete="current-password" required class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-700 sm:text-sm sm:leading-6">
        </div>
